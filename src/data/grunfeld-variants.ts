...
export const grunfeldVariants: TrainerVariant[] = [
  { id: "grunfeld-exchange", family: "Exchange", label: "3.Nc3 · Exchange Variation", moves: "1.d4 Nf6 2.c4 g6 3.Nc3 d5 4.cxd5", description: "Choose the right response to White's e4 setup and attack the broad centre.", probability: 34 },
