...
export const catalanVariants: TrainerVariant[] = [
  ...
  { id: "catalan-indian", family: "Indian setup", label: "Indian move order · ...Nf6 and ...e6", moves: "1.d4 Nf6 2.c4 e6 3.Nf3 d5", description: "Commit to Nf3 before building the Catalan fianchetto.", probability: 15 },
