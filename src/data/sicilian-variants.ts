...
export const sicilianVariants: TrainerVariant[] = [
  ...
  { id: "sicilian-closed-nge2", family: "Closed Nge2", label: "Closed Sicilian · Nge2 and Nd5", moves: "1.e4 c5 2.Nc3 d6 3.g3 Nf6 4.Bg2 g6 5.Nge2 Bg7 6.Nd5 Nc6", description: "Keep the normal Dragon setup against Nd5, then castle and expand on the queenside.", probability: 3 },
  { id: "sicilian-alapin-bishop-exchange", family: "Alapin bishop exchange", label: "Alapin · Bxd5 exchange", moves: "1.e4 c5 2.c3 Nf6 3.e5 Nd5 4.d4 cxd4 5.cxd4 d6 6.Nf3 Nc6 7.Bc4 dxe5 8.Bxd5", description: "Use the tactical ...Bh3 sacrifice, then exchange queens before recovering the c7 knight and entering a favourable practical ending.", probability: 2 },
];
