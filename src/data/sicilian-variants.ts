...
export const sicilianVariants: TrainerVariant[] = [
  { id: "sicilian-dragon-yugoslav", family: "Dragon Yugoslav", label: "Dragon · Yugoslav Attack", moves: "1.e4 c5 2.Nf3 d6 3.d4 cxd4 4.Nxd4 Nf6 5.Nc3 g6 6.Be3 Bg7 7.f3 Nc6 8.Qd2 O-O 9.Bc4", description: "Meet White's most aggressive setup with ...Bd7 and ...Rc8.", probability: 20 },
  ...
  { id: "sicilian-bowdler", family: "Bowdler", label: "Bowdler Attack · Bc4", moves: "1.e4 c5 2.Bc4 Nf6 3.d3 d5", description: "Challenge the bishop immediately, then fianchetto and castle.", probability: 9 },
  { id: "sicilian-smith-morra", family: "Smith-Morra", label: "Smith-Morra Gambit · c3", moves: "1.e4 c5 2.d4 cxd4 3.c3 dxc3", description: "Accept the pawn and contain White's initiative with active development.", probability: 8 },
  ...
  { id: "sicilian-closed-f4", family: "Closed f4", label: "Closed Sicilian · f4 setup", moves: "1.e4 c5 2.Nc3 d6 3.g3 g6 4.Bg2 Bg7 5.d3 Nc6 6.f4", description: "Use a Dragon-style fianchetto and start queenside counterplay with ...Rb8 and ...b5.", probability: 6 },
  ...
  { id: "sicilian-closed-nge2", family: "Closed Nge2", label: "Closed Sicilian · Nge2 setup", moves: "1.e4 c5 2.Nc3 d6 3.g3 g6 4.Bg2 Bg7 5.d3 Nc6 6.Nge2", description: "Meet White's quiet setup with ...e6, ...Nge7 and pressure on d4.", probability: 3 },
  { id: "sicilian-alapin-bishop-exchange", family: "Alapin bishop exchange", label: "Alapin · Bxd5 exchange", moves: "1.e4 c5 2.c3 Nf6 3.e5 Nd5 4.d4 cxd4 5.cxd4 d6 6.Nf3 Nc6 7.Bc4 dxe5 8.Bxd5", description: "Use the documented queen activity and central ...e5 break after White exchanges on d5.", probability: 2 },
];
